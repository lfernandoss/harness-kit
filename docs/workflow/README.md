...
### **🌐 SDK & Web Dashboard Guide**
→ **[SDK-AND-WEB-GUIDE.md](SDK-AND-WEB-GUIDE.md)**
- Architecture of the TypeScript/Node.js SDK and the Web Single Page Application (SPA).
- Agent Runner protocols (`antigravity-cli`, `claude-cli`, `copilot-cli`, `cursor-cli`).
- Web features: Socratic questionnaire, live SSE stream, F5 resilience, and timeline loop effects.
- Practical usage examples (Web, CLI, REST API, Programmatic).
