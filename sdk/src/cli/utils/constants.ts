...
export const HELP = `
@lfernandoss/harness-kit — autonomous orchestrator
...
DOCS
  https://github.com/lfernandoss/harness-kit
`

export const HELP_RUN = `
@lfernandoss/harness-kit — hrns run
...
@lfernandoss/harness-kit — hrns init
...
@lfernandoss/harness-kit — hrns settings
...
@lfernandoss/harness-kit — hrns diagnose
...
@lfernandoss/harness-kit — hrns candidate
...
@lfernandoss/harness-kit — hrns report
...
@lfernandoss/harness-kit — hrns version
...
DESCRIPTION
  Display the currently installed version of @lfernandoss/harness-kit SDK.
`
